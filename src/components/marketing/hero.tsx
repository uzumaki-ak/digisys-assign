    ...
    <div className="relative flex flex-col items-center justify-center w-full py-20">
      ...
      <div className="flex flex-col items-center justify-center gap-y-8 relative">
        <Container className="hidden lg:flex absolute inset-0 top-0 mb-auto flex-col items-center justify-center w-full min-h-screen -z-10">
          <OrbitingCircles speed={1} radius={400}>
            <Icons.circle1 className="size-4 text-foreground/70" />
            <Icons.circle2 className="size-3 text-foreground/80" />
          </OrbitingCircles>
          <OrbitingCircles speed={0.5} radius={500}>
            <Icons.circle2 className="size-5 text-foreground/50" />
            <Icons.circle1 className="size-5 text-foreground/60" />
            <Icons.circle2 className="size-3 text-foreground/90" />
          </OrbitingCircles>
        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
          <Container className="relative hidden lg:block overflow-hidden">
            <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
              ...
              <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                <span className="px-2 py-[0.5px] h-[18px] tracking-wide flex items-center justify-center rounded-full bg-gradient-to-r from-red-400 to-blue-green text-[9px] font-medium mr-2 text-white">
                  Ϟ
                </span>
                Your One Step Sol
              </span>
          ...
          >
            <h1 className="text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-br from-white to-gray-400">
          ...
          <Container delay={0.2}>
            <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-gray-500/50">
              Enabling smarter decisions and measurable results through
              strategic consulting and innovative thinking.
            </p>
          </Container>
          <Container delay={0.25} className="z-20">
            <div className="flex items-center justify-center mt-6 gap-x-4">
              <Link href="#" className="flex items-center gap-2 group">
                <Button
                  size="lg"
                  className=" hover:from-blue-600 hover:bg-sky-300 hover:text-black transition-colors duration-300"
                >
                  Get IN Touch
